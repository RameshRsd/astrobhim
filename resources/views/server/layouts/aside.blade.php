            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu" style="padding-top:20px;">
                <div class="menu_section">
                    ...
                    <ul class="nav side-menu">
                        ...
                        @endif
                            <li><a href="{{route('addGallery')}}"><i class="fa fa-image"></i> Add Gallery</a></li>
                            <li><a href="{{route('addNews')}}"><i class="fa fa-book"></i> Add News</a></li>
                            <li><a href="{{route('addService')}}"><i class="fa fa-spinner fa-pulse"></i> Add Service</a></li>
                            <li><a><i class="fa fa-align-justify"></i> About Us Update<span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    {{--<li><a href="{{route('addAbout')}}">About us</a>--}}
                                    {{--</li>--}}
                                    <li><a href="{{route('otherPages')}}">Other Pages</a>
                                    </li>
                                    {{--<li><a href="">Profile</a>--}}
                                    {{--</li>--}}
                                </ul>
                            ...
                            <li><a href="{{route('viewCategories')}}"><i class="fa fa-briefcase"></i> Categories</a>
